...
class DoublyLinkedList:
    ...
    def add_to_head(self, value):
        ...
        if self.head: 
            ...
            self.head = new_head
        else: self.tail, self.head = new_head, new_head
    ...
    def add_to_tail(self, value):
        ...
        if self.tail:
            ...
            self.head, self.tail = new_tail, new_tail
    ...
    def delete(self, node):
        ...
        elif node is self.head: self.head = node.next
        elif node is self.tail: self.tail = node.prev
    ...
    def get_max(self):
        if self.head != None:
            ...
            while cur_node:
                if cur_node.value > max: max = cur_node.value
